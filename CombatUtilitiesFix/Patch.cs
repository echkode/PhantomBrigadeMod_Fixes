...
using PBCombatUtilities = PhantomBrigade.CombatUtilities;

namespace EchKode.PBMods.CombatUtilitiesFix
{
	[HarmonyPatch]
	static class Patch
	{
		[HarmonyPatch(typeof(PBCombatUtilities), "ClampTimeInCurrentTurn")]
		[HarmonyTranspiler]
		static IEnumerable<CodeInstruction> ClampTimeInCurrentTurn_Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
		{
